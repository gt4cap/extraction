...
aoi="""POLYGON((9.77476+47.25687, 13.05967+47.3760, 13.93857+48.712719, 11.9610+50.4854798, 8.906839+50.387514, 9.77476+47.25687))"""
# Bayern
...
if len(entries) > 0:
    try:
        ...
        #conn = psycopg2.connect("dbname='postgres' user='postgres' host='localhost' password='DEMO4eosc'")
    except:
